				...
				<div class="row">
							 ...
							 <div class="card-body">
								<!-- <div class="row"> -->
								  <div class="col-lg-7 col-xl-12">
									 ...
									 <div id="map_rescue" style="width: 800px; height: 400px; position: relative; outline-style: none;"></div>
								  </div>
							 </div>
						   </div>
						</div>
				 ...
				 <div class="card radius-10">
                         <div class="card-body">
							<div class="d-flex align-items-center">
								<div>
									<h6 class="mb-0">Recent Tracking</h6>
								</div>
							</div>
						   ...
						   <table class="table align-middle mb-0">
							<thead class="table-light">
							 ...
							 <tbody>
							 	<?php 
									$no = 1;
									foreach($enduser_tb as $u){ 
								?>
								<tr>
									<td><?php echo $no++ ?></td>
									<td><?php echo $u->id ?></td>
									<td><?php echo $u->dest ?></td>
									<td><?php echo $u->type ?></td>
									<td><?php echo $u->msg ?></td>
									<td><?php echo $u->lat ?></td>
									<td><?php echo $u->lon ?></td>
